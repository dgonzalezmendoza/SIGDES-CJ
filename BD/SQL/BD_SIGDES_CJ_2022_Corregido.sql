...
CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`docentes` (
  ...
  `Doc_Nacionalidad` CHAR(3) NOT NULL,
  ...
  `Doc_Estatus` CHAR(1) NOT NULL DEFAULT '1',
  ...
  INDEX `fk_docentes_nacionalidad1_idx` (`Doc_Nacionalidad` ASC) ,
...
CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`matriculas_academicas` (
  ...
  `Mat_Beca_Fonabe` CHAR(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`modulos_convencionales` (
  ...
  `ModCon_Periodo` VARCHAR(10) NOT NULL,
  `ModCon_Creditos` TINYINT NULL,
  `ModCon_Equivalencia` VARCHAR(45) NULL,
  `ModCon_Nota_Minima` TINYINT NULL,
  PRIMARY KEY (`ModCon_Codigo`, `ModCon_Nivel`, `ModCon_Periodo`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`detalle_matricula_convencional` (
  ...
  `DetMatCon_Mod_Codigo` VARCHAR(10) NOT NULL,
  `DetMatCon_Mod_Nivel` VARCHAR(10) NOT NULL,
  `DetMatCon_Mod_Periodo` VARCHAR(10) NOT NULL,
  INDEX `fk_Detalle_Matricula_Ac_matriculas_ac1_idx` (`DetMatCon_Matricula` ASC) ,
  INDEX `fk_detalle_matricula_ac_modulos1_idx` (`DetMatCon_Mod_Codigo` ASC, `DetMatCon_Mod_Nivel` ASC, `DetMatCon_Mod_Periodo` ASC) ,
  ...
  CONSTRAINT `fk_detalle_matricula_ac_modulos1`
    FOREIGN KEY (`DetMatCon_Mod_Codigo` , `DetMatCon_Mod_Nivel` , `DetMatCon_Mod_Periodo`)
    REFERENCES `bd_sigdes_cj`.`modulos_convencionales` (`ModCon_Codigo` , `ModCon_Nivel` , `ModCon_Periodo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`matriculas_tecnicas` (
  ...
  `MatTec_Beca_Fonabe` CHAR(1) NOT NULL,
...
-- -----------------------------------------------------
-- Table `bd_sigdes_cj`.`notas_estudiante_convencional`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bd_sigdes_cj`.`notas_estudiante_convencional` ;

CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`notas_estudiante_convencional` (
  `NotaAc_Estudiante` VARCHAR(30) NOT NULL,
  `NotaAc_Nota` DECIMAL(5,2) NOT NULL,
  `NotaAc_Mod_Codigo` VARCHAR(10) NOT NULL,
  `NotaAc_Mod_Nivel` VARCHAR(10) NOT NULL,
  `NotaAc_Mod_Periodo` VARCHAR(10) NOT NULL,
  INDEX `fk_NOTAS_AC_estudiantes1_idx` (`NotaAc_Estudiante` ASC) ,
  INDEX `fk_notas_ac_modulos1_idx` (`NotaAc_Mod_Codigo` ASC, `NotaAc_Mod_Nivel` ASC, `NotaAc_Mod_Periodo` ASC) ,
  ...
  CONSTRAINT `fk_notas_ac_modulos1`
    FOREIGN KEY (`NotaAc_Mod_Codigo` , `NotaAc_Mod_Nivel` , `NotaAc_Mod_Periodo`)
    REFERENCES `bd_sigdes_cj`.`modulos_convencionales` (`ModCon_Codigo` , `ModCon_Nivel` , `ModCon_Periodo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`parametros_colegio` (
  ...
  PRIMARY KEY (`ParCol_Codigo_Colegio`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`modulos_opcionales` (
  ...
  `ModOp_Periodo` VARCHAR(10) NOT NULL,
  `ModOp_Creditos` TINYINT NOT NULL,
  PRIMARY KEY (`ModOp_Codigo`, `ModOp_Nivel`, `ModOp_Periodo`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`modulos_Emergente` (
  ...
  `ModEm_Periodo` VARCHAR(10) NOT NULL,
  `ModEm_Creditos` TINYINT NOT NULL,
  `ModEm_Requisito` VARCHAR(10) NULL,
  PRIMARY KEY (`ModEm_Codigo`, `ModEm_Periodo`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`detalle_matricula_opcional` (
  ...
  `DetMatOp_Mod_Codigo` VARCHAR(10) NOT NULL,
  `DetMatOp_Mod_Nivel` VARCHAR(10) NOT NULL,
  `DetMatOp_Mod_Periodo` VARCHAR(10) NOT NULL,
  INDEX `fk_detalle_matricula_opcional_matriculas_academicas1_idx` (`DetMatOp_Matricula` ASC) ,
  INDEX `fk_detalle_matricula_opcional_modulos_opcionales1_idx` (`DetMatOp_Mod_Codigo` ASC, `DetMatOp_Mod_Nivel` ASC, `DetMatOp_Mod_Periodo` ASC) ,
  ...
  CONSTRAINT `fk_detalle_matricula_opcional_modulos_opcionales1`
    FOREIGN KEY (`DetMatOp_Mod_Codigo` , `DetMatOp_Mod_Nivel` , `DetMatOp_Mod_Periodo`)
    REFERENCES `bd_sigdes_cj`.`modulos_opcionales` (`ModOp_Codigo` , `ModOp_Nivel` , `ModOp_Periodo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`matriculas_emergente` (
  ...
  `MatEmt_Beca_Fonabe` CHAR(1) NOT NULL,
  `MatEm_Beca_Avancemos` CHAR(1) NOT NULL,
  `MatEm_Beca_Otras` VARCHAR(200) NULL,
  `MatEm_Seccion` INT NOT NULL,
  `MatEm_Anho_Academico` CHAR(4) NOT NULL,
  `MatEm_Periodo_Academico` CHAR(1) NOT NULL,
  ...
  INDEX `fk_matriculas_emergente_periodos_academicos1_idx` (`MatEm_Anho_Academico` ASC, `MatEm_Periodo_Academico` ASC) ,
  ...
  CONSTRAINT `fk_matriculas_emergente_periodos_academicos1`
    FOREIGN KEY (`MatEm_Anho_Academico` , `MatEm_Periodo_Academico`)
    REFERENCES `bd_sigdes_cj`.`periodos_academicos` (`PerAc_Anho` , `PerAc_Periodo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`detalle_matricula_emergente` (
  ...
  `DetMatEm_Mod_Codigo` VARCHAR(10) NOT NULL,
  `DetMatEm_Mod_Periodo` VARCHAR(10) NOT NULL,
  INDEX `fk_detalle_matricula_emergente_matriculas_emergente1_idx` (`DetMatEm_Matricula` ASC) ,
  INDEX `fk_detalle_matricula_emergente_modulos_Emergente1_idx` (`DetMatEm_Mod_Codigo` ASC, `DetMatEm_Mod_Periodo` ASC) ,
  ...
  CONSTRAINT `fk_detalle_matricula_emergente_modulos_Emergente1`
    FOREIGN KEY (`DetMatEm_Mod_Codigo` , `DetMatEm_Mod_Periodo`)
    REFERENCES `bd_sigdes_cj`.`modulos_Emergente` (`ModEm_Codigo` , `ModEm_Periodo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `bd_sigdes_cj`.`notas_estudiante_opcional`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bd_sigdes_cj`.`notas_estudiante_opcional` ;

CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`notas_estudiante_opcional` (
  `NotaOp_Estudiante` VARCHAR(30) NOT NULL,
  `NotaOp_Nota` DECIMAL(5,2) NOT NULL,
  `NotaOp_ModOp_Codigo` VARCHAR(10) NOT NULL,
  `NotaOp_ModOp_Nivel` VARCHAR(10) NOT NULL,
  `NotaOp_ModOp_Periodo` VARCHAR(10) NOT NULL,
  INDEX `fk_nota_estudiante_opcional_estudiantes1_idx` (`NotaOp_Estudiante` ASC) ,
  INDEX `fk_nota_estudiante_opcional_modulos_opcionales1_idx` (`NotaOp_ModOp_Codigo` ASC, `NotaOp_ModOp_Nivel` ASC, `NotaOp_ModOp_Periodo` ASC) ,
  CONSTRAINT `fk_nota_estudiante_opcional_estudiantes1`
    FOREIGN KEY (`NotaOp_Estudiante`)
    REFERENCES `bd_sigdes_cj`.`estudiantes` (`Est_Cedula`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_nota_estudiante_opcional_modulos_opcionales1`
    FOREIGN KEY (`NotaOp_ModOp_Codigo` , `NotaOp_ModOp_Nivel` , `NotaOp_ModOp_Periodo`)
    REFERENCES `bd_sigdes_cj`.`modulos_opcionales` (`ModOp_Codigo` , `ModOp_Nivel` , `ModOp_Periodo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `bd_sigdes_cj`.`notas_estudiante_emergente`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bd_sigdes_cj`.`notas_estudiante_emergente` ;

CREATE TABLE IF NOT EXISTS `bd_sigdes_cj`.`notas_estudiante_emergente` (
  `NotaEm_Nota` DECIMAL(5,2) NOT NULL,
  `NotaEm_Est_Cedula` VARCHAR(30) NOT NULL,
  `NotaEm_ModEm_Codigo` VARCHAR(10) NOT NULL,
  `NotaEm_ModEm_Periodo` VARCHAR(10) NOT NULL,
  INDEX `fk_notas_estudiante_emergente_estudiantes1_idx` (`NotaEm_Est_Cedula` ASC) ,
  INDEX `fk_notas_estudiante_emergente_modulos_Emergente1_idx` (`NotaEm_ModEm_Codigo` ASC, `NotaEm_ModEm_Periodo` ASC) ,
  CONSTRAINT `fk_notas_estudiante_emergente_estudiantes1`
    FOREIGN KEY (`NotaEm_Est_Cedula`)
    REFERENCES `bd_sigdes_cj`.`estudiantes` (`Est_Cedula`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_notas_estudiante_emergente_modulos_Emergente1`
    FOREIGN KEY (`NotaEm_ModEm_Codigo` , `NotaEm_ModEm_Periodo`)
    REFERENCES `bd_sigdes_cj`.`modulos_Emergente` (`ModEm_Codigo` , `ModEm_Periodo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
