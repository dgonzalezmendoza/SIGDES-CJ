<div id="DIV_Ges_Ad_Periodo_Academico" name="DIV_Ges_Ad_Periodo_Academico">
            ...
            <div class="col-12">
                <div class="card rounded p-4">
                    <div class="card-header rounded text-center p-4">
                        <h4 class="mb-0 text-white">Periodos lectivos académicos</h4>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input type="number" style="text-align: center" class="form-control BordeBlanco-y-Pulsar" id="Txt_Anho_GAd_PeriodoAca" maxlength="4" required autocomplete="nope">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="number" style="text-align: center" class="form-control BordeBlanco-y-Pulsar" id="Txt_Nombre_GeAd_PeriodoAcademico" maxlength="1" required autocomplete="nope">
                                <div class="valid-feedback">
